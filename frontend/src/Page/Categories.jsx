        ...
        <div className="container mt-5">
          ...
          <div className="row g-4 text-center">
            ...
            <div className="col-6 col-lg-3">
              ...
              <span className="section-tag2 fw-bold section-tag2">
                STEP 01
              </span>
    ...
    <div class="accordion" id="faqAccordion">
      ...
      <div class="accordion-item">
        ...
        <div id="faq1" class="accordion-collapse collapse show" data-bs-parent="#faqAccordion">
          <div class="accordion-body">
            Pick the category that most closely matches the issue. If nothing fits, use "Others" and describe the
            problem in detail — an administrator will re-route it to the right technician if needed.
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item">
        ...
        <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
          <div class="accordion-body">
            Priority is set automatically based on category and can be adjusted by an administrator. High-priority
            issues (like electrical faults or water leakage) are targeted for repair within 24 hours.
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item">
        ...
        <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
          <div class="accordion-body">
            Yes. When you report an issue under any category, you can attach one or more images to help the
            technician understand the problem before they arrive.
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item">
        ...
        <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
          <div class="accordion-body">
            You'll get a status update on your dashboard as the technician moves your complaint through
            Assigned → In Progress → Resolved, and you can leave feedback once it's marked resolved.
          </div>
        </div>
      </div>
