 ...
 */
export default function ProfileTab({ complaints, onBack, admin, onUpdateAdmin, settings, onUpdateSettings }) {
      ...
      <div className="profile-grid">
        ...
        <div className="card">
          ...
          <div className="profile-setting-row" style={{ borderBottom: "none" }}>
            ...
            <span className="link-action" style={{ color: C.danger }}>Log out</span>
          </div>
        </div>
      </div>
    </div>
